...
## Check the right number of players have been picked up    
...
removeDigits = re.compile(r'[a-zA-Z]+')
    ...
    for link in links:
        ...
        for player in playerStats:
            if getSQLdata.countPlayerData (cursor,player,playerStats[player]['team']) > 0:              
                ...
                getSQLdata.writePlayerData (cursor,player,playerStats[player]['team'],playerStats[player])    
